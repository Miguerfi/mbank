  ...
  const data = [
    {
      id: 1,
      title: "Área Pix",
      icon: <Image style={operacoesStyle.pix} source={pix} />,
    },
    {
      id: 2,
      title: "Transferir",
      icon: <Image style={operacoesStyle.transferencia} source={transferir} />,
    },
    {
      id: 3,
      title: "Pagar",
    ...
    },
    {
      ...
      icon: <Image source={cellphone} style={operacoesStyle.cell} />,
    },
    {
      id: 5,
      title: "Depositar",
      icon: <Image style={operacoesStyle.deposito} source={deposito} />,
    },
    {
      id: 6,
      title: "Transferir Internac.",
      icon: <Image style={operacoesStyle.internacional} source={transInter} />,
    },
    {
      id: 7,
      title: "Doação",
      icon: <Image style={operacoesStyle.doacao} source={doacao} />,
    },
    {
      id: 8,
      title: "Cobrar",
      icon: <Image style={operacoesStyle.cobrar} source={cobrar} />,
    },
  ];
  return (
