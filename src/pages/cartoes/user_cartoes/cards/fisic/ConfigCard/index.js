    ...
    return (
        <View style={configCard.main}>
            <View style={configCard.viewBox}>
                ...
                <Switch style={configCard.switchB} onValueChange={toggleSwitch} value={isEnabled} trackColor={{ false: 'grey', true: '#e0bcdd', }} thumbColor={isEnabled ? 'purple' : '#e9e9e9'} />
            </View>
            <View style={configCard.viewBox}>
                <Text style={configCard.headerTextWarning}>Cartão perdido ou danificado</Text>
                <TouchableOpacity>
                    <AntDesign name="right" style={configCard.setaRight} size={26} color="grey" />
                </TouchableOpacity>
            </View>
            <View style={configCard.viewBox}>
